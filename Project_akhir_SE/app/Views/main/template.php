    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      ...
      <ul class="nav">
        ...
        <?php if (in_groups('admin')) : ?>
          ...
          <?php if (in_groups('admin_inventory')) : ?>
            <li class="nav-item menu-items">
              ...
              <div class="collapse" id="inventory">
                <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="<?= base_url('Persediaan/index') ?>"> Stok Persediaan </a></li>                
                </ul>
              </div>
            <?php endif ?>
            </li>
            <?php if (in_groups('admin_pemasaran')) : ?>
              <li class="nav-item menu-items">
                ...
                <div class="collapse" id="auth">
                  <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="<?= base_url('/LaporanPemasaran/index') ?>"> Laporan </a></li>
                  </ul>
                </div>
              <?php endif ?>
              </li>
              <?php if (in_groups('admin_supplier')) : ?>
                <li class="nav-item menu-items">
                ...
                <?php if (in_groups('admin_hr')) : ?>
                  <li class="nav-item menu-items">
                    ...
                    <div class="collapse" id="auth">
                      <ul class="nav flex-column sub-menu">
                         <li class="nav-item"> <a class="nav-link" href="<?= base_url('Karyawan/index') ?>"> Data Karyawan</a></li>
                         <li class="nav-item"> <a class="nav-link" href="<?= base_url('Riwayat/index') ?>"> Data Riwayat Login</a></li>
                <li class="nav-item"> <a class="nav-link" href="<?= base_url('Absensi/index') ?>"> Absensi </a></li>
